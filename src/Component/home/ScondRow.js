...
import Wrapped from "./SecondStyle";
function ScondRow() {
  return (
    <Wrapped>
          ...
          <div className="cardstyle">
            ...
            <div className="cardContent">
              <div data-aos="fade-right">
                ...
                perfect design with responsive. And Maintain a clear vision of
                the final product
              </div>
            </div>
          </div>
          ...
          <div className="cardstyle">
            ...
            <span className="cardContent">
              <div data-aos="fade-left">
                Incorporate the new feactures and idea's in project and
                maintained the clear execution of the final product and client
                requirements
              </div>
            </span>
          </div>
