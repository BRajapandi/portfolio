        ...
        .profileSub {
          ...
          span {
            ...
            &::after {
              ...
              font-size: 25px;
              font-weight: 600;
              transform: translate(-12px, -25px) rotate(-10deg);
            }
          }
        }
        .abtBtnWrapper {
          button {
            ...
            border: none;
            box-shadow: 2px 2px 3px var(--dark-text-color7);
            color: white;
            font-size: 16px;
            font-weight: 600;
            letter-spacing: 2px;
